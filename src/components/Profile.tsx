      ...
      {!isEdit && (
        <>
          ...
          <div className="px-8 mt-10 pb-5 border-b border-[#36404A] ">
            ...
            <p className="text-white text-lg text-center">{details?.user_name}</p>
          ...
          <div className="px-8 py-5">
            ...
            <div className="pb-3">
              ...
              <p className="text-white text-sm ">{moment(details?.createdAt).format("DD MMM YYYY").toString()}</p>
            </div>
          </div>
          <div className="text-white text-lg cursor-pointer px-8 pb-5 absolute bottom-0 flex items-center gap-2">
