...
import { GroupListApi, searchGroupApi, searchUserApi } from "@/services/api.service";
import {
  faArrowLeft,
  faSearch,
  faUserGroup,
    ...
    const getGroupChatList = async () => {
      try {
        ...
        let grpList=list.data;
          grpList.sort((a:any, b:any) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());

          grpList = grpList.filter((value:any, index:any, self:any) => 
