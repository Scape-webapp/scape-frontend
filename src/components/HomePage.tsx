...
function HomePage() {
  ...
  return (
    <>
      ...
      {/* next viewpot */}
      <div className="">
        <div className="w-full max-w-screen-2xl mx-auto px-5 md:px-20 pt-10">
            ...
            <div className="flex items-center justify-center">
              <div className="md:px-10">
                ...
                <h3 className="md:text-2xl text-sm">
                  ...
                  Whether you're connecting with friends, colleagues, or
                  creating communities, Scape provides a platform where your
        ...
        <div className="w-full px-5 md:px-20 pt-10 bg-[#F6F6F6]">
              ...
              <div className="flex items-center justify-center">
                <div className="md:px-10">
                  ...
                  <h3 className="text-sm md:text-2xl">
                    ...
                    robust group chat feature. Collaborate on projects, plan
                    events, or just catch up with friends – all within the
                    convenience of a group chat.
                  </h3>
                </div>
              </div>
              <div className="flex items-center justify-center">
        ...
        {/* next viewpot */}
        <div className="px-5 w-full max-w-screen-2xl mx-auto md:px-20 pt-10 ">
          <div className="grid md:grid-cols-2">
            <div className="flex items-center justify-center">
              <Image
                src={GroupChatPeople}
            ...
            <div className="flex items-center justify-center">
              <div className="md:px-10">
                ...
                <h3 className="text-sm md:text-2xl">
                  Scape offers real-time messaging, enabling you to stay
                  connected with your contacts no matter where you are. Share
                  messages, emojis, and multimedia effortlessly for a truly
        ...
        <div className="px-5 md:px-20 pt-10 bg-[#F6F6F6]">
          <div className="flex justify-center items-center py-10">
            <div>
              ...
              <h3 className="text-sm md:text-2xl pb-8 text-center">
                Navigate Scape effortlessly, whether you're a tech enthusiast or
                a casual user
              </h3>
              <Image
                className="m-auto"
